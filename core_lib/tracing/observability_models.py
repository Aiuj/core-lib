...
- session_id: Session identifier (client-provided, groups multiple API calls)
- process_id: Process identifier (server-generated per request, correlates all logs for one API call)
...
Note: process_id is automatically generated by the server middleware for each
request. It does not need to be supplied by the client.
...
class FromMetadataSchema(BaseModel):
    ...
    Fields:
        ...
        process_id: Server-generated unique identifier for a single request/process execution
    ...
    # Process context (server-generated per request)
    process_id: Optional[str] = Field(
        None,
        description="Server-generated unique identifier for a single API call or process execution. "
                    "Auto-generated by middleware; enables correlating all logs for one request."
    )
